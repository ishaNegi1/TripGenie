    ...
    <div className="grid gap-6 lg:grid-cols-[1.2fr_1fr]">
      <section className="rounded-xl border border-zinc-200 p-4 dark:border-zinc-800">
        <div className="mb-3 flex items-center justify-between">
          <h1 className="text-lg font-semibold">{trip.destination} Trip Chat</h1>
          <div className="flex gap-2">
            <button onClick={() => send("Regenerate the full itinerary.")} className="rounded-md border border-zinc-300 px-3 py-1.5 text-sm dark:border-zinc-700">
              Regenerate Plan
            </button>
            <Link href="/new-trip" className="rounded-md border border-zinc-300 px-3 py-1.5 text-sm dark:border-zinc-700">New Trip</Link>
            <Link href="/dashboard" className="rounded-md border border-zinc-300 px-3 py-1.5 text-sm dark:border-zinc-700">Back to Dashboard</Link>
          </div>
        </div>
        ...
        <form onSubmit={onSubmit} className="mt-4 flex gap-2">
          <input
            ...
            placeholder="Ask to tweak this trip..."
            value={prompt}
      ...
      <section className="space-y-4">
        {hasItinerary ? (
          ...
          <div className="rounded-xl border border-dashed border-zinc-300 p-6 text-sm text-zinc-600 dark:border-zinc-700 dark:text-zinc-400">
            No itinerary yet. Press &quot;Regenerate Plan&quot; or send a prompt.
          </div>
        )}
      </section>
    </div>
